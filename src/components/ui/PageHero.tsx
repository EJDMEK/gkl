...
const PageHero: React.FC<PageHeroProps> = ({ 
  ...
  return (
    ...
    >
      ...
      {/* Hlavní obsah */}
      <div className="relative z-10 text-center text-white px-4 sm:px-6 md:px-8 max-w-5xl mx-auto w-full">
        {/* Dekorativní prvek nad nadpisem */}
        <div className="flex justify-center mb-4">
          <FlowerDecoration size="md" className="text-white/80" />
        </div>
        
        {/* Nadpis */}
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-2 sm:mb-3 md:mb-4 text-balance leading-tight tracking-tight drop-shadow-lg">
          {title}
        </h1>
        
        {/* Podnadpis */}
        {subtitle && (
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/95 max-w-3xl mx-auto leading-relaxed font-light drop-shadow-md mt-2 sm:mt-3">
            {subtitle}
          </p>
        )}
