    ...
    <div className="font-preview-1">
      ...
      <Section className="bg-primary-dark text-white py-4">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <p className="text-lg font-semibold">Náhled fontu: <span className="text-secondary">Lora</span></p>
