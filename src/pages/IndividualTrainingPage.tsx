...
const IndividualTrainingPage: React.FC = () => {
  useI18n()
  ...
  return (
    <div>
      {/* Hero Title */}
      <PageHero 
        title="Individuální a skupinová výuka"
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="p-6 md:p-8">
            <p className="text-lg text-neutral-dark leading-relaxed mb-4">
              Pro naprosté začátečníky (zájemce o golf, kteří ještě golf nikdy nehráli) jsou ve spolupráci s ČGF v nabídce <strong>Bav se golfem</strong> připraveny na našem hřišti tyto golfové balíčky.
            </p>
          </Card>
        </div>
      </Section>
